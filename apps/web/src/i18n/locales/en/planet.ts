...
export const planet = {
  ...
  reach: {
    ...
    frontierNote: 'Each project is researched once and uses Construction. A locked card states its unlock condition.',
    isotopeName: 'Isotope Spectrometry',
    isotopeTag: 'Unlocks Deuterium mining',
    isotopeRole: 'Shows the Deuterium in isotope rocks and lets you send Prospectors to them. The return haul enters the Works.',
    denseName: 'Dense Fuel Cells',
    denseTag: 'Unlocks the Runner',
    denseRole: 'To reveal it, fill your cargo in one raid while loot remains on the target. The Runner is faster than a Hauler but carries less.',
    graviticName: 'Gravitic Charges',
    graviticTag: 'Unlocks the Breacher',
    graviticRole: 'To unlock it, attack a defended world with an active Aegis; the shield must absorb at least {{share}} of your damage. A single Wasp can qualify; you do not need to win. The Breacher hits shields five times harder.',
    deathStarName: 'Death Star Protocol',
    deathStarTag: 'Unlocks the Death Star',
    deathStarRole: 'Lets this world build one Death Star. The first strike devastates its target; a second can capture only a colony or neutral world. A capital cannot be captured.',
    ...
    researchShieldInsight: 'Have an Aegis absorb at least {{share}} of your raid damage',
