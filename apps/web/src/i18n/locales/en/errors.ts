...
export const errors = {
  ...
  BAD_CLAN_AID_FLEET: 'Choose at least one mobile ship',
  ...
  MINING_ALREADY_ARRIVED: 'Prospectors cannot be recalled after reaching their target',
  MINING_RUN_NOT_FOUND: 'That Prospector flight no longer exists',
  ...
  PROBE_COOLDOWN: 'Another probe can launch in {{seconds}} sec.',
  PROSPECTOR_TRANSFER_FORBIDDEN: 'Prospectors cannot be transferred between worlds',
  ...
  HANGAR_FULL: 'Hangar full: {{used}} / {{capacity}} room used; this order needs {{needed}}. Raise the Hangar for more room.',
  ...
  PLACEMENT_CHANGED: 'Your galaxy changed. Refresh and try again.',
  RETURN_TARGET_UNAVAILABLE: 'Your former galaxy is unavailable right now.',
  NOT_IN_WAITING: 'You are already in a main galaxy.',
  WAITING_JOIN_FORBIDDEN: 'Choose an available main galaxy to begin playing.',
  ...
  TARGET_HANGAR_FULL: 'That world’s Hangar is full: {{used}} / {{capacity}} room used; this fleet needs {{needed}}.',
