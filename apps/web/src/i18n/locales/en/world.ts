...
export const focus = {
  ...
  planet: {
    ...
    capitalProtectedHint: 'A Death Star clears storage and Works, destroys craft at home and lowers building levels; control never changes.',
    capitalRecovering: 'Capital devastated · uncapturable',
    capitalRecoveringHint: 'You may strike again: damage repeats and its 6h recovery restarts; control still cannot change.',
    ...
    claimDeathStarConsequence: 'A Death Star clears this claim and starts 6h recovery. A second impact is the capture route.',
    ...
    firstImpact: 'Damage + 6h recovery',
