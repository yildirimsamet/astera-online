...
export const vocabulary = {
  ...
  satellite: {
    ...
    FOUNDRY: {
      ...
      detail: 'Körük, yalnız kurulduğu dünyanın saatlik alaşım, kristal ve Döteryum üretimini %6 artırır. Üretim hızına bağlı havuz ve depo kapasiteleri de aynı oranda yükselir; Deponun akınlardan koruduğu miktar değişmez. Kazıcı ambarını ve akın ganimetini artırmaz.',
    },
    DERRICK: {
      name: 'Matkap',
  ...
  hull: {
    ...
    PIKE: {
      ...
      role: 'Okla aynı bedelde daha çok saldırır ve daha az dayanır; Akıncı hedeflere karşı sınıf üstünlüğü kazanır.',
      pitch: 'Saldırısı dayanımından yüksektir; güçlü ilk salvo karşılığında daha kırılgan bir gövde alırsın.',
      detail: 'Kargı, Ok ve Kirpi gibi Akıncı sınıfı hedefleri avlayan giriş seviyesi bir Mızraktır. Okla aynı bedelde daha yüksek saldırı ve daha düşük dayanım satın alır; daha yavaş uçar. Sur sınıfı gemiler ile Tabya onu karşılar. Bu nedenle tek tip Kargı filosunun açık ve etkili bir cevabı vardır.',
    },
    RAMPART: {
      name: 'Sur',
      tag: 'Giriş seviye kale gemisi',
      role: 'Muhafızla aynı bedelde daha çok dayanım sunar; bunun karşılığında daha az saldırır ve filoyu daha fazla yavaşlatır.',
    ...
    WARDEN: {
      ...
      role: 'Surla aynı bedelde daha hızlı ve daha saldırgandır; bunun karşılığında daha az dayanır.',
      pitch: 'Kale gövdesinin bir bölümünü saldırı ve filo temposuyla değiştirir.',
      detail: 'Muhafız, Surla aynı kaynak bedelini ödeyen hareketli bir Sur refakatçisidir. Ham saldırısı ve hızı Surdan yüksek, gövde dayanımı düşüktür. Saf kuşatma ve savunmada Sur; tempo isteyen karma filolarda Muhafız daha anlamlıdır.',
    },
    COURIER: {
      name: 'Kurye',
    ...
    TALON: {
      ...
      role: 'Engerekle aynı bedelde belirgin biçimde daha çok saldırır; daha az dayanır, daha yavaş uçar ve Akıncıları avlar.',
    ...
    STRONGHOLD: {
      name: 'Hisar',
      tag: 'Ağır hat gemisi',
      role: 'Nöbetçiyle aynı bedelde ikinci seviyenin en yüksek dayanımını sunar; daha az saldırır ve daha yavaş uçar.',
    ...
    SENTINEL: {
      ...
      role: 'Hisarla aynı bedelde daha hızlı ve daha çok saldıran, fakat daha az dayanan ikinci seviye refakatçidir.',
    ...
    TEMPEST: {
      ...
      role: 'Araştırmayla açılan üçüncü seviye Akıncıdır; Ok, Engerek ve Korsanla savaş gemilerinin en yüksek ham hızını paylaşır.',
    ...
    BALLISTA: {
      ...
      role: 'Kasırgayla aynı bedelde belirgin biçimde daha çok saldıran, daha az dayanan ve daha yavaş uçan üçüncü seviye Mızraktır.',
    ...
    LEVIATHAN: {
      ...
      role: 'Praetoryenle aynı bedelde daha çok dayanır; daha az saldırı ve daha düşük hızla üçüncü seviye duvar kurar.',
    ...
    PRAETORIAN: {
      ...
      role: 'Leviathanla aynı bedelde daha çok saldırır ve daha hızlı uçar; bunun karşılığında daha az dayanır.',
    ...
    NULLIFIER: {
      ...
      role: 'Saldırısı dayanımından yüksek Mızrak uzmanıdır; aktif kalkan üzerinde normal etkisinin beş katını üretir.',
    ...
    CATACLYSM: {
      ...
      role: 'Korsanla aynı bedelde belirgin biçimde daha çok saldıran, daha az dayanan ve daha yavaş uçan dördüncü seviye Mızraktır.',
    ...
    CORSAIR: {
      ...
      detail: 'Korsan, dördüncü seviyede Sur sınıfına cevap veren tek gemidir ve en yüksek savaş hızı kademesini Ok, Engerek ve Kasırgayla paylaşır. Kıyametten daha az ham saldırıya sahip olsa da Kale duvarlarına karşı Akıncı sınıfı üstünlüğü kazanır; Mızrak sınıfı hedefler ise onu karşılar.',
    },
    CITADEL: {
      name: 'Kale',
      tag: 'Başkent kale gemisi',
      role: 'Palatinle aynı bedelde daha çok dayanır; daha az saldırır ve dördüncü seviye savaş gemileri içinde en yavaş uçuşu yapar.',
    ...
    PALADIN: {
      ...
      role: 'Kaleyle aynı bedelde daha çok saldırır ve daha hızlı uçar; bunun karşılığında daha az dayanır.',
    ...
    PROSPECTOR: {
      ...
      detail: 'Kazıcı yalnız keşfedilmiş asteroitlere ve enkaz sahalarına gönderilir. Taban hızı 825, taban ambarı 300’dür; Matkap ve Kazıcı Ambarları araştırması bu değerleri artırabilir. Her dünya başlangıçta en fazla iki Kazıcı tutar; Kazıcı Ambarları III üçüncü araç yuvasını açar. Normal akınlara katılmaz ve ev savunmasında savaşmaz.',
    },
  },
