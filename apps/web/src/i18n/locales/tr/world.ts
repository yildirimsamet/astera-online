...
export const focus = {
  ...
  planet: {
    ...
    capitalProtectedHint: 'Ölüm Yıldızı stokları ve Havuz’u siler, evdeki araçları yok eder ve bina seviyelerini düşürür; kontrolü asla el değiştirmez.',
    capitalRecovering: 'Ana gezegen harap · ele geçirilemez',
    capitalRecoveringHint: 'Tekrar vurabilirsin: hasar yeniden uygulanır ve 6 saatlik toparlanma baştan başlar; kontrol yine el değiştirmez.',
    ...
    claimDeathStarConsequence: 'Ölüm Yıldızı bu hakkı siler ve 6sa toparlanma başlatır. Ele geçirme yolu ikinci darbedir.',
    ...
    firstImpact: 'Hasar + 6sa toparlanma',
