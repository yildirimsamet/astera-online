...
export const errors = {
  ...
  BAD_CLAN_AID_FLEET: 'En az bir hareketli gemi seç',
  ...
  CONVOY_ALREADY_RAIDED: 'Bu dünya bu Galaksilerarası Konvoya zaten saldırdı',
  CONVOY_FLEET_ALREADY_AWAY: 'Bu dünyadan Galaksilerarası Konvoya bir akın zaten yolda',
  CONVOY_NEEDS_COMBAT_FLEET: 'Ateş gücü olan bir filo gönder',
  ...
  MINING_ALREADY_ARRIVED: 'Kazıcılar hedefe ulaştıktan sonra geri çağrılamaz',
  MINING_RUN_NOT_FOUND: 'Bu kazıcı uçuşu artık mevcut değil',
  OUT_OF_RANGE:
  ...
  PROBE_COOLDOWN: 'Yeni sonda {{seconds}} sn sonra gönderilebilir.',
  PROSPECTOR_TRANSFER_FORBIDDEN: 'Kazıcılar gezegenler arasında aktarılamaz',
  ...
  HANGAR_FULL: 'Hangar dolu: {{capacity}} alanın {{used}} kadarı kullanımda; bu sipariş {{needed}} alan istiyor. Daha fazla yer için Hangarı yükselt.',
  ...
  PLACEMENT_CHANGED: 'Galaksin değişti. Yenileyip tekrar dene.',
  RETURN_TARGET_UNAVAILABLE: 'Eski galaksin şu anda kullanılamıyor.',
  NOT_IN_WAITING: 'Zaten bir ana galaksidesin.',
  WAITING_JOIN_FORBIDDEN: 'Oyuna başlamak için açık bir ana galaksi seç.',
  ...
  TARGET_HANGAR_FULL: 'O dünyanın Hangarı dolu: {{capacity}} alanın {{used}} kadarı kullanımda; bu filo {{needed}} alan istiyor.',
