...
export const trade = {
  ...
  noCarrier: "Kurye, Seyyah, Atlas veya Argosi gerek",
  ...
  holdNoCarrier: "Ambarı yalnız Kurye, Seyyah, Atlas ve Argosi taşır — birini seç.",
  ...
  needsCarrier: "Kurye, Seyyah, Atlas veya Argosi ekle",
