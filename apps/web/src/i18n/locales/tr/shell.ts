...
export const menu = {
  ...
  researchHint: 'On beş proje; sende ve tuttuğun her dünyada geçerli',
  ...
  feedbackHint: 'Ekibe hata, istek / öneri veya tebrik gönder',
  clanLabel: 'Klan',
  clanHint: 'Beş kişilik bir ekip bul veya kendin kur',
  clanMemberLabel: 'Klan · [{{tag}}]',
  clanMemberHint: 'Ekip, yardım, ortak ganimet ve özel sohbet',
