...
export const keys = {
  ...
  archivedLeaderboard: (seasonId: string) => ['season-archive', 'leaderboard', seasonId] as const,
  seasonCommanderProfile: (resultId: string) => ['season-archive', 'profile', resultId] as const,
