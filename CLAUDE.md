...
- **Only the CAPITAL's Command Core gates what a commander unlocks** (D209): colony slots open at capital Core 6 / 9 / 12 (`colonyCoreThresholds`), and research is gated and timed by `researchCoreLevel` whichever world funds it. A captured world's Core never counts.
