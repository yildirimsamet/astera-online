...
- D204 raises the Intergalactic Convoy's frozen production cap to **2 hours**, every pirate
  ...
  and isotope concentration remain separate and unchanged. The pirate supply allowance rises
  5% → 6.5%, but admission stays on the frozen ×1.4 valuation so live target indexes do not move.
